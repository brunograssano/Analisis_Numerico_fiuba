...
\begin{titlepage} % Carátula
    ...
    \vfill
    \begin{tabular}{ | l | l | } % completen con padron
      \hline
        De Angelis Riva, Lukas & xxxxxx \\ \hline
        Gomez, Joaquin & xxxxxx \\ \hline
        Grassano, Bruno & 103855 \\ \hline
        Guillemi, Andres & xxxxxx \\ \hline
        Rodriguez, Ezequiel & xxxxxx \\ \hline
        Romero, Adrian & xxxxxx \\ \hline
  	\end{tabular}
    \vfill
    \vfill
    \vfill
...
\begin{itemize}
    \item[$*$]Usando bisección:  1.4142135623715149+-
    \item[$*$]Usando Newton Raphson:  1.414213562373095+-
\end{itemize}
...
%faltan los gráficos y analizar la parte de P y lambda

\subsubsection{Segunda función}\label{sec:CR2}

Usando la biblioteca sympy, las raíces halladas fueron:
\begin{itemize}
    \item[$*$]Usando bisección:   1.2000045776367188+-
    \item[$*$]Usando Newton Raphson:  1.2000066214794778+-
\end{itemize}
